...
var $author$project$Test$phrase = 'Hi help me';
	...
	var phraseHtml = A2(
		...
		A2(
			...
			A2(
				...
				A2($elm$core$String$split, '', $author$project$Test$phrase))));
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Test$main = $elm$browser$Browser$element(
	{aB: $author$project$Test$init, aM: $author$project$Test$subscriptions, aP: $author$project$Test$update, aQ: $author$project$Test$view});
